...
<html lang="en">
   <head>
      ...
      <!-- bootstrap-wysiwyg -->
      <link href="<?php echo FRAMEWORK_URL_TPL ?>/gentellela/vendors/google-code-prettify/bin/prettify.min.css" rel="stylesheet">
      <!-- Select2 -->
      <link href="<?php echo FRAMEWORK_URL_TPL ?>/gentellela/vendors/select2/dist/css/select2.min.css" rel="stylesheet">
      <!-- Switchery -->
      <link href="<?php echo FRAMEWORK_URL_TPL ?>/gentellela/vendors/switchery/dist/switchery.min.css" rel="stylesheet">
      <!-- starrr -->
      <link href="<?php echo FRAMEWORK_URL_TPL ?>/gentellela/vendors/starrr/dist/starrr.css" rel="stylesheet">
